...
// // ✅ NEW: Simple phone update thunk (replaces OTP verification)
...
//       // Update user's phone in auth slice
//       dispatch(updateUser({
//         phone: response.user.phone
//       }));

//       // Retry the original pending request
...
//           };
//         } catch (retryError) {
//           // If retry fails, still close modal but show error
//           dispatch(showToast({
...
//       state.loading = true;
//       state.error = null;
//     }).addCase(updatePhoneThunk.fulfilled, (state) => {
//       state.loading = false;
//       state.isOpen = false;
//       state.phone = null;
//       state.pendingRequest = null;
