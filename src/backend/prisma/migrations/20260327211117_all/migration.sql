...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('AGENT_PROPERTY_ASSIGNED', 'AGENT_PROPERTY_UNASSIGNED', 'AGENT_TENANT_ASSIGNED', 'AGENT_TENANT_UNASSIGNED', 'PROPERTY_NOTE_CREATED', 'BOOKING_CREATED', 'BOOKING_APPROVED', 'BOOKING_REJECTED');
