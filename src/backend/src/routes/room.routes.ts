...
router.get('/:id/demand-stats', (req, res) => roomController.getDemandStats(req, res));
router.get('/:id', (req, res) => roomController.getRoomById(req, res));
router.post('/', authMiddleware, authorizeRoles(Role.OWNER, Role.ADMIN), validateBody(CreateRoomSchema), (req, res, next) => roomController.createRoom(req as any, res));
